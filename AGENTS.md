...
| CI | `.github/workflows/validation-gate.yml` | Runs the same seven commands as the validation gate below, in the same order. When the gate changes, change the workflow in the same PR. |
