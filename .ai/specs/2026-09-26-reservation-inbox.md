...
- Date: 2026-09-26 · Author: `om-auto-write-spec` (autonomous) · Status: **ready for review — Q11 was confirmed by the owner on 2026-09-26 and recorded as D24. Phase 1 still contains no model call or egress; the A07/A08 paper check remains a precondition before Phase 2 implementation.**
...
- Mode: `om-spec-writing --autonomous`. Every question resolved without a human is listed under **Resolved assumptions (autonomous defaults)**, and **A2 was confirmed by the owner and recorded in D24.**
...
| **What the app checks about a sender** | The allow-list, the DMARC verdict, and quarantine without storage as the standing policy (A4) | proposed follow-up decision; relaxing the policy later needs an explicit security decision |
