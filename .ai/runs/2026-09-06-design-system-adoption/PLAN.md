...
|-------|------|-------|------|--------|--------|
| 1 | 1.1 | Load Plus Jakarta Sans (spec step 1) | dispatch:cheap | todo | — |
...
| 2 | 2.5 | Migrate off the bridge aliases and delete the bridge (spec step 11) | dispatch | todo | — |
| 2 | 2.6 | Phase-2 screenshot set (spec step 12) | inline | todo | — |
