...
|-------|------|-------|------|--------|--------|
| 1 | 1.1 | Attachment, AttachmentBlob and UploadEvent models with their Alembic revision | dispatch:capable | todo | — |
| 1 | 1.2 | `domain/uploads.py` — byte sniffing, structural checks, dimensions, filename normalisation | dispatch:capable | todo | — |
